    ...
    return {
      ...
      sideNavbarList: [
        ...
        // },
        {
          ...
          //   {
          //     key: "index",
          //     title: this.$t("SIDENAV.notifications.showAll"),
          //     route: "/all-notifications/all",
          //     hasPermission: true,
          //   },
          //   {
          //     key: "create",
          //     title: this.$t("SIDENAV.notifications.add"),
          //     route: "/all-notifications/create",
          //     hasPermission: true,
          //   },
          // ],
        },
        ...
        },
        {
          ...
          children: [
            {
              key: "index",
              title: this.$t("PLACEHOLDERS.All_Nationalities"),
              route: "/nationalities/all",
              hasPermission: false,
            },
            {
              key: "create",
              title: this.$t("PLACEHOLDERS.add_nationality"),
        ...
        },
        {
          ...
          children: [
            ...
            {
              key: "create",
              title: this.$t("PLACEHOLDERS.add_ads"),
              route: "/ads/create",
              hasPermission: false,
            },
          ],
