...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      REQUEST_DATA.append("publish_start_date", this.data.publish_start_date);
      REQUEST_DATA.append("publish_end_date", this.data.publish_end_date);
    ...
    async getAdsData() {
      try {
        let res = await this.$axios({
          method: "GET",
          url: `admin/ad-spaces/${this.$route.params.id}`,
        });
        this.data.image.path = res.data.body.add_space.image;
        this.data.nameAr = res.data.body.add_space.nameAr;
        this.data.nameEn = res.data.body.add_space.nameEn;
        this.data.publish_start_date = res.data.body.add_space.publish_start_date;
        this.data.publish_end_date = res.data.body.add_space.publish_end_date;
        this.data.active = res.data.body.add_space.is_active;
