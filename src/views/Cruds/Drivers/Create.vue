      ...
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <base-input col="6" type="text" :placeholder="$t('PLACEHOLDERS.numberOrdersAllowedPerDay')"
            v-model.trim="data.numberOrdersAllowedPerDay" />
  ...
  methods: {
    ...
    validateFormInputs() {
      ...
      // }
        ...
        return;
      } else if (!/[a-z]/.test(this.data.password) || !/[A-Z]/.test(this.data.password) || !/[0-9]/.test(this.data.password)) {
        this.isWaitingRequest = false;
        this.$message.error(this.$t("VALIDATION.passwordRequirements"));
        return;
