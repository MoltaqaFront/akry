  ...
  data() {
    return {
      ...
      tableHeaders: [
        ...
        {
          text: this.$t("TABLES.Coupons.usingNumber"),
          value: "using_number",
          align: "center",
        },
        {
          text: this.$t("TABLES.Coupons.startDate"),
          value: "start_at",
          align: "center",
        },
        {
          text: this.$t("TABLES.Coupons.endDate"),
          value: "end_at",
          align: "center",
        },
        {
  ...
  methods: {
    ...
    async setTableRows() {
      ...
      try {
        ...
        this.tableRows = res.data.body.coupons;
    ...
    async changeActivationStatus(item) {
      try {
        await this.$axios({
          method: "PUT",
          url: `admin/coupons/${item.id}/activate`,
        });
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `admin/coupons/${this.itemToDelete.id}`,
        });
