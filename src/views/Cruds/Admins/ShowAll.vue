      ...
      >
        ...
        <template v-slot:[`item.actions`]="{ item }">
          <div class="actions">
            ...
            <template v-if="!permissions.edit && !permissions.delete && !permissions.activate">
  ...
  data() {
    return {
      ...
      tableHeaders: [
        ...
        {
          text: this.$t("TABLES.Admins.active"),
          value: "is_active",
          align: "center",
          width: "120",
        },
  ...
  methods: {
    ...
    async setTableRows() {
      ...
      try {
        ...
        this.tableRows = res.data.body.admins;
    ...
    async HandlingItemActivationStatus(selectedItem) {
      ...
      try {
        await this.$axios({
          method: "PUT",
          url: `admin/admins/${targetItem.id}/activate`,
    ...
    async confirmDeleteItem() {
      try {
        await this.$axios({
          method: "DELETE",
          url: `admin/admins/${this.itemToDelete.id}`,
        });
