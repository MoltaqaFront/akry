...
export default {
  ...
  methods: {
    ...
    async getDataToEdit() {
      try {
        ...
        this.data.phone = res.data.body.admin.phone;
        this.data.role = res.data.body.admin.role[0];
  ...
  async created() {
    // Start:: Fire Methods
    await this.$store.dispatch("PermissionsModule/checkRoutePermissions", "admins edit");
    this.getRoles();
    this.getDataToEdit();
    // End:: Fire Methods
  },
