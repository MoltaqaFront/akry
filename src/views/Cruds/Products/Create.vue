      ...
      <form @submit.prevent="validateFormInputs">
        <div class="row">
          ...
          <base-input col="6" type="text" :placeholder="$t('PLACEHOLDERS.price_after_discount')"
            v-model.trim="data.price_after_discount" required /> -->
          <!-- End:: Price Input -->
          ...
          <div class="all_content">
            ...
            <div class="row repeat_parent" v-for="(parent, parentIndex) in parents" :key="'a' + parentIndex"
              style="border: 2px solid #F6A513;margin-bottom:20px">
              ...
              <div class="row repeat_child align-items-center" v-for="(child, childIndex) in parent.children"
                :key="'b' + childIndex">
                <div class="col-lg-6 col-12">
...
export default {
  ...
  methods: {
    ...
    addChild(parentIndex) {
      if (!this.parents[parentIndex].children) {
        this.$set(this.parents[parentIndex], "children", []);
      }
      this.parents[parentIndex].children.push({
        nameAr: '',
        nameEn: '',
        price: '',
      });
    ...
    async submitForm() {
      ...
      this.parents.forEach((parent, parentIndex) => {
        ...
        REQUEST_DATA.append(`additions[${parentIndex}][multiple_choice]`, parent.multiple_choice.id);
        REQUEST_DATA.append(`additions[${parentIndex}][required]`, parent.required_item.id);
