  ...
  methods: {
    ...
    async resendVerificationCode() {
      ...
      try {
        ...
        localStorage.setItem("bring_admin_dashboard_verification_code", res.data.body.code);
    ...
    async submitForm() {
      ...
      if (this.verificationType == "reset-password") {
        try {
          ...
          console.log("DATA =>", res.data.body.forget_password_token);
          localStorage.setItem("bring_admin_dashboard_forget_pass_token", res.data.body.forget_password_token);
          this.$message.success(this.$t("MESSAGES.verifiedSuccessfully"));
          this.clearFormInputs();
          localStorage.removeItem("bring_admin_dashboard_verification_code");
          localStorage.removeItem("bring_admin_dashboard_email");
